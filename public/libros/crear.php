<?php
    ...
    if(isset($_POST['enviarForm'])){
        ...
        if($_FILES['logo']['error']==0){
            ...
            $_SESSION['mensaje']="Libro creado exitosamente $txt";
            header('Location:index.php'); //creo el libro y me redirijo a la página principal
            die();
...
<body style="background-color:lemonchiffon">
    ...
    <h5 class="text-center mt-4">Crear Libro</h5> 
        <div class="container">
            <form method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>" class="mx-auto bg-secondary px-4 py-4 rounded" style="width:40rem" enctype="multipart/form-data"> <!--NO OLVIDAR EL ENCTYPE-->

                <div class="mb-4">
                    <label for="t" class="form-label">Titulo</label>
                    <input type="text" id="t" class="form-control" placeholder="Introduce el titulo del nuevo libro" name="titulo" required />
                    <?php mostrarError('error_titulo') ?>
                </div>

                <div class="mb-4">
                    <label for="i" class="form-label">Isbn</label>
                    <input type="text" id="i" class="form-control" placeholder="Introduce el isbn del nuevo libro" name="isbn" required />
                ...
                <div class="mb-4">
                    <div class="my-4 text-center">
                            <img class="img-thumbnail" src="./img/default.png" id="image" style="width:8rem; height:8rem" />
